...
class ReactionEngine:
    ...
    async def schedule_reactions_for_post(self, post_id: str, post_author: str) -> Dict[str, Any]:
        """
        ...
        for bot in visible_bots:
            ...
            will_react = random.random() < max(bot.like_probability, bot.comment_probability)
            ...
            if will_react:
                ...
                scheduled_count += 1
                logger.info(f"Scheduled reaction for bot {bot.name} to post {post_id} in {delay} seconds")
