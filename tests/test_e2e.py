...
async def test_end_to_end():
    ...
    try:
        ...
        post_id = post_result["post"]["id"] if "post" in post_result and "id" in post_result["post"] else "test_post_id"
        
        reaction_result = await reaction_engine.schedule_reactions_for_post(post_id, bot_name)
